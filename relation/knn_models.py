...
from knn_faiss import knn_soft_train
...
class BertForRelation(BertPreTrainedModel):
    ...
    def knn_loss(self, knn_target, logits):
        loss_fct = CrossEntropyLoss()
        knn_soft_loss = loss_fct(logits.view(-1, self.num_labels), knn_target.view(-1))
        return knn_soft_loss

    def forward(self, knn, knn_target, input_ids, token_type_ids=None, attention_mask=None, labels=None, sub_idx=None, obj_idx=None, input_position=None):
